...
Moreover, in addition to being able to react, glial cells can also release chemokines.
...
<!--These actions are thought to be mediated *via* multifaceted mechanisms, including modulation of channel properties, intracellular calcium levels, synaptic transmission, and neuroendocrine signaling in many brain regions. + neuron - glial interactions  /// The multifaceted role for CXCR4 is mirrored by  the complexity of the mechanisms underlying its biological  function including receptor cross talk, receptor and ligand  isoforms, non-canonical ligands, and termination of signaling--><!-- Mounting evidence illustrates that chemokine, beyond their neuroinflammatory functions, also orchestrate the neuron-glia crosstalk, which is essential in maintaining brain homeostasis.
