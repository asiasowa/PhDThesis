...
To this end, by using a combination of electrophysiological and pharmacological approaches, actions of two chemokines (CX3CL1 and CXCL12) on neuronal properties as well as synaptic transmission were determined.
...
In order to confirm the neuronal expression of CX3CR1, the immunohistochemical staining was used. 

In the BLA, CX3CL1 increased threshold, reducing neuronal excitability of principal cells. 
...
The application of the inhibitor of microglial activity, minocycline, eliminated the CX3CL1-triggered effects.
...
The firing reduction of RS neurons consequently reduced frequency of sIPSCs in Late-Firing cells (LF).
Those effects were eliminated in the presence of the antagonist of CX3CR1 receptor, AZD8797, or minocycline, the inhibitor of microglial activity.
This points to network activty in the CeA is, at least in part, modulated by the CX3CR1 activation.
...
These changes are in line with the CXCL12-induced increase in glutamatergic transmission observed by another group.
...
The CXCR4 activation triggered an increased frequency of sIPSCs onto Regular-Spiking neurons, whereas the amplitude of this events in Late-Firing neurons was reduced. 
Those effects were blocked in the presence of CXCR4 receptor antagonist and by inhibiton of astrocytic activity by fluorocitrate. 

Altogether, findings from this study highlight neuromodulatory role of CX3CL1 and CXCL12 in both nuclei of the amygdala, which is a consequence of their regulation of local neuron-glial communication.
Further investigation in this area will lead to better understanding of neuroimmunological mechanisms in the amygdala and provide novel insights into neuro-immune mechanisms in the amygdala and yield new targets for developing treatments of amygdala-related disorders.
<!-- Therefore, these results imply CX3CL1/CX3CR1 and CXCL12/CXCR4 fine-tuning on the network level in the amygdala and the behavioral relevance of their modulation. --><!-- Continued investigation in this vein will hopefully provide novel insights into neuro-immune mechanisms in the amygdala and yield new targets for developing treatments of amygdala-related disorders.
-->
