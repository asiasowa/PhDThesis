...
<!-- z powodu .... widely expression and neuron-glial modulation? -->

These actions are thought to be mediated *via* multifaceted mechanisms, including modulation of channel properties, intracellular calcium levels, and neuroendocrine signaling in many brain regions.<!-- + neuron - glial interactions  /// The multifaceted role for CXCR4 is mirrored by  the complexity of the mechanisms underlying its biological  function including receptor cross talk, receptor and ligand  isoforms, non-canonical ligands, and termination of signaling-->
