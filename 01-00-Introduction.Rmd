...
<!-- The biological relevance of chemokine dimerization is still a matter of debate and its impact on receptor binding, stoichiometry and biased signaling remains to be unraveled [128,132,150,151] @kleist_2016. -->
Moreover, an increasing number of data shows that dimer formation is regulated by other factors, such as pH or interactions with glycosaminoglycans [@kleist_2016], adding another level of complexity. <!--   the vast majority of chemokines are able to form dimeric species, with the monomer-dimer equilibrium being regulated by factors such as pH, anions and interactions with glycosaminoglycans [127,128] ///Thus, dimers may provide new targets for chemokine receptor-based therapies. Synthetic peptides of TM regions of chemokine receptors may interfere with homologous interactions and inhibit functional activity of the receptors. /// Chemokines not only interact with receptors where different oligomeric forms can induce different signaling responses, they also interact with glycosaminoglycans which can stabilize oligomers and other structures that would not otherwise form in solution -->

Heterodimerization has been identified as a major mechanism that underlies the synergistic activity of various chemokine pairs (51, 52), as well as chemokines with other inflammatory mediators (53). - Collins2017 - <!-- . In the past 10 yr, several studies revealed the existence of additional features of chemokines: they can antagonize chemokine receptors or synergize with other chemokines, also by forming heterocomplexes-->

the vast majority of chemokines are able to form dimeric species, with the monomer-dimer equilibrium being regulated by factors such as pH, anions and interactions with glycosaminoglycans [127,128] .
 Additionally, some chemokines have been observed to form tetramers ( e.g. CCL2, CCL5, CCL27, CXCL4, and CX3CL1) or higher-order oligomers [130,135–139] . Heterodimers of two different CC or CXC chemokines as well as cross-family CC/CXC heterodimers have also been reported [140–142] . 

Receptor dimerization has been reported as essential for the functionality and signaling properties of the chemokine system [@wang_2008].
Formation of homo- or heterodimers has been demonstrated for all four chemokine receptor subfamilies (C, CC, CXC, CX3C).
Moreover, chemokine can form heterodimers with other GPCRs families, including adrenergic and opioid receptors [@kleist_2016].
Consistently, it was documented that CXCR4 co-localizes and interacts with a `r knitr::asis_output("\U03BC")`-opioid receptor in the periaqueductal grey neurons [@heinisch_2011].
...
CXCR4 is one of several CKRs reported to undergo homodimerization upon CXCL12 binding [] <!-- Vila-Coro et al., 1999-->
This phenomenon is thought to be required for the functionality and signaling properties of chemokine receptors. 
For instance, CXCR4 has a propensity to form hetero- and homooligomers [@babcock_2003; @percherancier_2005], and such oligomerization could play a role in the allosteric regulation of CXCR4 signaling [@wang_2008; @wu_2010]. <!--zmienić bo zerżnięte z @wu_2010 -->
CXCR4 has been reported to dimerize with CCR2 and CCR5, and both complexes show negative binding cooperativity with their ligands, not only in vitro but also in vivo [@sohy_2009]<!--plus @wang_2006-->, an observation that may have implications for drug efficacy. <!--zmienić bo zerżnięte z @wu_2010 -->

CXCL12 and its antagonist AMD3100 can inhibit CCL2 binding only in cells co-expressing CCR2 and CXCR4, but not CCR2 alone, suggesting that binding of CXCL12 to CXCR4 in the heterodimer transinhibited the binding of CCL2 to its receptor CCR2 in the receptor heterodimer. <!-- zmienić i wang_2008 -->

However, it is not clear that native CCR5 can directly bind CXCR4 and one study reported only weak binding of CCR5 and CXCR4 by BRET assay [26] .
 
CCR2 and CXCR4 were shown to heterodimerize by BRET analysis [21] . 
...
Following CXCL12 interaction, CXCR4 undergoes a homo-dimerization which is necessary for its functionality and signaling ( Mellado et al., 2001 ; Toth et al., 2004 ).

CXCR4 could also form heterodimers with other GPCRs, which could lead to complex responses according to the chemokines/peptides/neuromediator environment present in the extracellular medium. For example, CXCR4 has been shown to form heterodimers with CCR2 and CCR5, delta opioid receptors and CXCR7 ( Percherancier et al., 2005 ; Pello et al., 2008 ; Levoye et al., 2009 ; Sohy et al., 2009 ). However, by co-expressing in the membrane of Xenopus oocytes GABABreceptors tagged with Td tomato (red fluorophore) and CXCR4 receptors tagged with green fluorescent protein (GFP), data obtained in total internal reflection fluorescence (TIRF) microscopy showed that CXCR4 and GABABreceptors did not co-localize in the membrane (A. Guyon, unpublished data).
