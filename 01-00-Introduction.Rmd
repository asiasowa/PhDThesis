...
As is the case for the chemokines, the receptors can also be grouped into four major families, CR, CCR, CXCR, and CX3CR, which interact with the C, CC, CXC, and CX3C chemokines, respectively (see Fig. \@ref(fig:family)).
...
They enable tight and rapid control of chemokine signaling and its quick response to the dynamic microenvironment.
These processes include (1) post-translational modifications, (2) redundancy, (3) dynamic chemokine-receptor interactions, (4)  diversity in signaling pathways after chemokine activation, (5) atypical chemokine receptors, (6) dimerization, (7) interactions with other proteins on the membrane surface, and (8) biased-signaling.
...
One of the example is, as mentioned above (see: \@ref(cx3cl1str)), the production of CX3CL1 transmembrane form.
The dynamic proteolytic cleavage of CX3CL1 is thought to be a response to neurotoxic insult and serves anti-inflammatory functions [@chapman_2000], suggesting its important role in the regulation of inflammation.
Consistent with this idea, many factors may control the soluble expression of CX3CL1.
...
Another essential aspect of chemokine-induced signaling is their rich repertoire of ligand-receptor relationships (for reviews: @zlotnik_2000, @hughes_2018, Fig. \@ref(fig:chemmechanisms), part b and Fig. \@ref(fig:chemoexpression)).
...
Biased signaling, also known as functional selectivity, is another feature specific for GPCR receptors that provides a framework for understanding how a finite set of chemokine ligands generates myriad functionally diverse outcomes (@zweemer_2014, @kleist_2016, see: Fig. \@ref(fig:chemmechanisms), part d).
...
Noting the CKRs' diverse cellular distribution and the complexity of chemokine ligand-receptor interactions, it is evident that chemokine receptors may activate different intracellular pathways in a ligand- and cell-specific context (see: Fig. \@ref(fig:chemmechanisms), part c). 
