...
These results suggest their brain-specific functions. <!--involved in many physiological brain functions, both in development (cell migration and differentiation, neuronal circuits maturation etc.) and adulthood (regulation of synaptic plasticity and cognitive functions). // such as the modulation of synaptic transmission [@rostne_2007]. -->
...
As chemokines constitute one of the most tightly regulated systems, their signaling is modulated *via* a broad array of factors, which are discussed below.
...
#### Chemokine signaling {#chemokinessignal}
...
#### Chemokine expression in the CNS {#chemokinesexpression}

Chemokines and CKRs are expressed by healthy neurons, microglia, astrocytes, oligodendrocytes, and endothelial cells (for a comprehensive review, see: @sowa_2021).
Broadly, the neuroanatomical distributions of several chemokines and their corresponding receptors overlap in many regions in the healthy CNS, suggesting their involvement in local communication.
Consistent with this,chemokines  and their receptors play a  key role  as mediators of homeostatic crosstalk between neurons and glia.  
