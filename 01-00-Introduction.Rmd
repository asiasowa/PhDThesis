...
Thus, relative to CXCR4, ACKR3 acts as a `r knitr::asis_output("\U03B2")`-arrestin biased receptor (see: \@ref(chemokinessignal)).
...
Specifically, @montpas_2018 demonstrated that both siRNA knockdown of `r knitr::asis_output("\U03B2")`-arrestin1 and or `r knitr::asis_output("\U03B2")`-arrestin2 in HEK293 cells do not affect ACKR3-mediated scavenging of either of ACKR3's ligands (i.e., CXC11 and CXCL12). 
