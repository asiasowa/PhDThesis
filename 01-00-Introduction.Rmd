...
The expression of ACKR3, along with its behavioral relevance, will be described later in this dissertation (see Section \@ref(CXCL12)). 
...
As chemokines constitute one of the most tightly regulated systems, their signaling is modulated *via* a broad array of factors, discussed below.
