...
Considering CX3CL1 and CX3CR1 expression, this genetic strain is one of the most essential tools for studying the consequences of neuron-microglia communication following CX3CL1-CX3CR1 axis dysregulation [@paolicelli_2014].
...
Similarly, during hippocampal development, CX3CR1^-/-^ deficient microglia showed impaired migration [@pagani_2015; @paolicelli_2011].
...
Although dendritic spine density remained unchanged, neurons from CX3CR1^-/-^ mice still displayed a lower frequency of mEPSCs and sEPSCs compared to their wild-type littermates. 
...
Moreover, in adult mice, pharmacological inhibition of microglial activation was associated with preventing dendritic spine loss in obese mice [@cope_2018].
...
Notably, gene insertion of only soluble variant of CX3CL1, not the membrane-anchored version, was shown to rescue motor coordination and reduce neurodegeneration in the PD model [@morganti_2012].
...
Similar to studies concerning the neuroprotective action of CX3CL1 described above, this CX3CL1-induced adenosine action on the glutamatergic transmission was revealed to be mediated by A~3~R, and to the lesser extend A~1~R  [@lauro_2008, @lauro_2010; @piccinin_2010].   
...
Moreover, a recent study demonstrated that the depletion of CX3CR1 might affect the adaptive response to psychosocial stress, which is a significant risk factor for psychotic disorders such as schizophrenia [@piirainen_2021].