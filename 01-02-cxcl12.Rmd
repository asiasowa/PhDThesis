...
For example, it is estimated that a single cortical astrocyte make contact from 20,000 to 120,000 synapses in  rodents and up to 2,000,000 synapses in humans [@oberheim_2009], suggesting bidirectional communication. 
Indeed, they are endowed with a great variety of ion channels and receptors [@olsen_2015, @seifert_2018, @kofuji_2021] to react to changing microenvironment as well as they can release a substantial set of gliotransmitters [@araque_2014, @savtchouk_2018, @covelo_2018]. 
...
Considering that virtually all types of brain cells express either CXCL12 and/or one of its receptor, this chemokine serves a wide array of functions in both the developing and mature brain.
...
It is well established that CXCL12 is responsible for generation and positioning of new neurons within these niches, as well as their axonal and dendritic outgrowth and branching  [@abe_2015; @abe_2018; @zhu_2017].
...
Importantly, as interneurons are guided to the correct destination by CXCL12 gradient, ACKR3, by acting as a "sink" to collect excess CXCL12, also is implicated in this phenomenon [@snchezalcaiz_2011].>
...
By acting on presynaptic site, this molecule affects serotoninergic, dopaminergic, and melanin-concentrating hormone (MCH)-containing neurons, and thereby modulating the release of their neurotransmitters and neuropeptides [@guyon_2005; @guyon_2006; @heinisch_2010]. 
...
Consistent with this data, further behavioral study has illustrated that by using unilateral intranigral or intracerebroventricular injections of CXCL12 in the rat SN, it was shown that this chemokine induced contralateral turns in circling behavior [@skrzydelski_2007]. 
Of note, considering that considering that both CXCL12 and CXCR4 are co-expressed in dopamine neurons<!-- citations -->, it is tempting to speculate that this chemokine may act in an autocrine manner [@guyon_2008a].
...
This effect was independent on CXCR4 receptor, action potential-dependent sodium channel, and GABA~A~ receptors [@guyon_2006], suggesting that this chemokine may induce glutamate release from astrocytes.
...
Alternatively, it may be also mediated on CXCR4-expressing microglial cells. 
However, the exact mechanism of action of CXCL12 a on glutamate release still warrants further investigation.
...
It is a physiological and psychological state characterized by decreased mood, anorexia, and fatigue due to immune activation during the course of infection, which is primarily mediated by the central action of peripherally released proinflammatory cytokines [@dantzer_2001, @dantzer_2007]. 
...
Thus, the effect of CXCL12 on serotonergic neurons in the DRN and could underlie depressive symptoms , as dysfunction of the serotoninergic systems is implicated in depression.
<!-- Moreover,  amygdala --> 
Thus, given our evolving understanding of how CXCL12/CXCR4 or CXCL12/ACKR3 are involved in the control of intercellular communication between brain cells, as well as in synaptic transmission, plasticity, and behavior, further mechanistic and theoretical understanding of their actions will undoubtedly be of great basic and translational benefit.  <!-- napisać lepsze podsumowanie.... Overall, this chemokine system is one of the key players in the neuro-immune interface that participates in shaping CNS responses to changes in the environment. While much effort has been done to investigate the mechanisms underlying CXCL12/CXCR4 or CXCL12/ACKR3-mediated regulation of synaptic transmission and plasticity and their specific properties in certain synapses and brain regions,  their impact on network function and animal behavior have only been initially explored. Taken together, the relevance of the aforementioned actions of CXCL12/CXCR4/ACKR3 signaling to mechanisms implicated in many neurobiological disorders is suggestive of -->