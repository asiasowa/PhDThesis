...
ACKR3's signaling pathways are discussed later in section "Biased Signaling" \@ref(biasedsignaling).<!-- skopiować z later...-->
...
Additionally, as mentioned previously, CXCR4 is often co-expressed with opioid receptors in neurons and astrocytes, frequently forming heterodimers [@burbassi_2010], whereas ACKR3 is implicated in chemokine-opioid interactions [@ikeda_2013, @meyrath_2020]<!-- inaczej napisać -->, illustrating interactions between chemokine and opioid systems (see Section: \@ref(opio), for review: @mlikparsadaniantz_2015). <!-- poprawić odwołanie-->
...
<!--In relation to astrocytes, it is increasingly evident that these cells actively participate in synaptic transmission.  nowe cytowania? -->

In addition to glutamate, CXCR4 is also known to release prostaglandins and TNF`r knitr::asis_output("\U03B1")` upon activation by CXCL12 on astrocytes [@bezzi_2001], which has key functional consequences on the neuronal networks as described in the next section (\@ref(scal)). <!-- CXCL12 induces the tumor necrosis factor a (TNF a )-mediated Glu release from astrocytes (Bezzi et al., 2001) and TNF a increases the surface expression of synaptic AMPARs (Beattie et al., 2002) . @lax_2002-->
...
<!-- CXCL12 has been shown to be released with GABA from  inhibitory neurons (Bhattacharyya et al., 2008).  -->
...
Moreover, this chemokine is packed in small dense vesicles in the nerve terminals of these neurons, which are then released from neuronal cell bodies and terminal nerve endings in a calcium-dependent manner (for example: ). <!-- cytowanie z CXCL12 --><!-- CXCL12 is stored in vesicle like structures within neurons which seem to be neurotransmitter storage vesicles (Bhattacharyya et al. 2008). --> 
...
#### Interneurons {#interinter} / neurodevelopment
...
The first evidence that CXCL12 has effects on neurons and promotes neuroprotection were given by Meucci et al. (1998) when, for the first time, the authors demonstrated that CXCL12 reduced the apoptotic death of hippocampal neurons induced by gp120 or by glia deprivation. Following glia deprivation, neuroprotection was promoted by administration of CXCL12 specifically to neurons highlighting a direct activity of the chemokine on these cells. Further, stimulation of hippocampal neurons with CXCL12 was able to induce Akt phosphorylation and p65NF-kB nuclear translocation, both signaling implicated in pro-survival cell fate ( Khan et al., 2004 ).
...
<!--Furthermore, ACKR3 activation promotes β-arrestin2- and dynamin-dependent Cx43 internalization to inhibit gap junctional intercellular communication in primary astrocytes. @fumagalli_2020 
...
Since the tripartite synapse concept emerged in 1999 [@araque_1999], it is well-established that astrocytes are involved in the dynamic regulation of synaptic transmission (for example: @araque_2014).
To react to changing microenvironment, they are endowed with a great variety of voltage and ligand-operated  ion  channels [@kofuji_2021].
Astrocytes display a wide variety of Ca^2+^ signals, particularly relevant in astrocytic signaling, as Ca^2+^ fluctuations are thought to integrate environmental information  and  generate  functional outputs, such as releasing gliotransmitters, including glutamate, D-serine, GABA, ATP, adenosine, or TNF`r knitr::asis_output("\U03B1")` [@araque_2014, @guerragomes_2017].  

Moreover, astrocytes are enriched in gap junctions, by which they form broad cellular networks comprised of hundreds of cells, allowing for the intercellular diffusion of ions, second messengers, cyclic AMP, Ca^2+^, glutamate, ATP, among others. 
Gap junctions are formed by connexins, mainly by Cx43 and Cx30, which differ in their expression.
Despite their scale, such networks were illustrated to preferentially couple one astrocyte over the other.
Therefore neighboring astrocytes may not necessarily be connected by gap junctions, and such preference may be of functional relevance.
Moreover, gap junction networks were demonstrated to play an essential role in complex brain functions, including cognition and behavior (for a review: @guerragomes_2017). 
As ACKR3 was demonstrated to induce the internalization of Cx43 [@fumagalli_2020], future studies aimed at establishing its functional significance and whether other chemokine receptors may elicit similar actions are warranted. 
