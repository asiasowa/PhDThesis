...
To react to changing microenvironment, they are endowed with a great variety of voltage and ligand-operated ion  channels [@olsen_2015, @seifert_2018, @kofuji_2021] as well as they can release a substantial set of gliotransmitters [@araque_2014, @savtchouk_2018, @covelo_2018]. <!-- bidirectional communication :) // Since the tripartite synapse concept emerged in 1999 [@araque_1999], it is well-established that astrocytes are involved in the dynamic regulation of synaptic transmission (for example: @araque_2014).To react to changing microenvironment, they are endowed with a great variety of voltage and ligand-operated  ion  channels [@kofuji_2021]. -->
...
Moreover, astrocytes are enriched in gap junctions, by which they form broad cellular networks comprised of hundreds of cells, allowing for the intercellular diffusion of ions, second messengers, cyclic AMP, Ca^2+^, glutamate, ATP, among others. <!-- citations? -->
Gap junctions are formed by connexins, mainly by Cx43 and Cx30, which differ in their expression.
Despite their scale, such networks were illustrated to preferentially couple one astrocyte over the other. <!-- citations? -->
...
Another analogous action that is similar to CX3CL1 is CXCL12 implication in the regulation of neurogenesis.
