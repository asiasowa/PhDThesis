...
Moreover, they are modulated by external factors, including chemokines, such as  CXCL12, CX3CL1, and CCL2 [@meucci_1998; @liu_2003; @sheridan_2014].<!-- może lepiej to sklecić -->
...
In addition, another chemokine, CCL3, one of the CCR5 ligands (see Section: \@ref(ccr5)), was also shown to significantly reduced basal synaptic transmission and  LTP at the Schaffer collateral-CA1 hippocampal synapses [@marciniak_2015]. 
Furthermore, CCL3-induced LTP impairment was completely prevented by co-injection with maraviroc, a blocker of the CCR5 receptor. 
...
Similar to CX3CL1, CXCR5 was also reported to enhance the proliferation of SGZ cells in the DG.
Nonetheless, no difference in microglial density or their activation was observed [@stuart_2014], implying microglia-independent action.
...
More recently, in another study, the expression of one chemokine, CXCL1, was elevated in the  visual cortex, which was exposed to gamma frequency synchronization [@garza_2020].
