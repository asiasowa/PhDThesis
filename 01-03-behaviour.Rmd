## Chemokines modulates behaviour
...
Increasing evidence has indicated the role of another chemokine receptor, CCR5, in cognitive functions (Table 3).<!-- poprawna nazwa tabeli -->
While the activation or overexpression of CCR5 was reported to impair the hippocampal and cortical neuronal plasticity, leading to deficits in learning and memory [@zhou_2016],<!--Recent evidence suggests that CCR5 may impact learning and memory by acting on CREB signaling, a pathway critical for learning and memory (Josselyn et al., 2004; Sano et al., 2014; Zhou et al., 2009). --> both genetic depletion and pharmacological inhibition of CCR5 was shown to enhance memory in rats [@merino_2020], as measured by both fear-conditioning (contextual learning) and Morris water maze (spatial learning; see Table 3).
