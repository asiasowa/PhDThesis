...
Further electrophysiological analyses have identified at least six distinct types of firing properties [@jasnow_2009; @mahanty_1998; @sosulina_2010; @woodruff_2007]. <!-- figure ? //specific subpopulations of GABAergic interneurons have different firing patterns -->
Although some evidence has begun to elucidate a distinct electrophysiological profile based on these neuromarkers, such as short-duration action potentials with no adaptation in PV-expressing cells [@rainnie_2006; @woodruff_2007] and broad spikes with clear adaptation produced by CB-immunopositive interneurons [@jasnow_2009], the correlation between <!-- marker? --> and <!-- firing patterns --> is not fully determined and the role of this electrophysiological heterogeneity is still unclear. <!-- once again which of these versions is correct?! For example, four electrophysiologically separable types of cells were found to express PV in combination with either CCK or CB [@sosulina_2010]. -->
...
As mentioned above,  <!--and subsequent expression of behavioral responses -->is not only determined by the sensory excitatory inputs to BLA principal cells, but also  . <!-- These cells (interneurons) ;  --> <!-- SKRÓCIĆ TO ZDANIE ZNACZNIE ..... --->
