...
In most cases, those afferents project to both principal neurons and GABAergic interneurons (see Fig. \@ref(fig:amygdalaconnect), part a).
...
The glutamate and GABA transmission within the BLA is strongly modulated by a wide array of neuromodulators (see Fig. \@ref(fig:amygdalaconnect), part a).
...
On the other hand, somatostatin-positive interneurons predominantly target distal dendrites and spines of these pyramidal-like neurons (@muller_2007, see Fig. \@ref(fig:amygdalaconnect), part c).
...
Among many sensory inputs mentioned in the previous section (see: \@ref(BLAinputs), \@ref(fig:amygdalaconnect), part a), the prefrontal cortex (PFC, especially its medial part) and the ventral hippocampus (vHPC) have strong reciprocal connections with the BLA complex [@sah_2003]. 
...
ITC neurons receive projections from BLA and mainly target more ventrally located ITCs and the CeA, forming an inhibitory interface<!--gate--> between the BLA and CeA (@busti_2011; @marowsky_2005; @royer_2000, see Fig. \@ref(fig:amygdalaconnect), part b). 
...
As mentioned previously, the BLA predominantly projects to the CeA (see Fig. \@ref(fig:amygdalaconnect), part b and c). 
...
The CeA can be innervated by BLA principal cells either directly by forming glutamatergic synapses onto CeA neurons (@krettek_1978, @lopezdearmentia_2004 or indirectly *via* GABAergic ITCs neurons, leading to feedforward inhibition (@jngling_2008; @royer_1999, see Fig. \@ref(fig:amygdalaconnect), part b).
...
For instance, the paraventricular nucleus of the thalamus (PVT), a region activated by physical and psychological stressors<!-- stress sensor 1-3-->, was demonstrated to send projections to the CeL,  preferentially innervating SOM-containing neurons (@domonte_2015; @penzo_2015, Fig. \@ref(fig:amygdalaconnect), part a). 
...
Similarly, oxytocinergic neurons from the hypothalamus, another brain region innervating CeL, were illustrated to send their axon terminals onto CeL neurons (@knobloch_2012, see Fig. \@ref(fig:amygdalaconnect), part a).
...
Furthermore, CeL, especially its PKC`r knitr::asis_output("\U03B4")`-expressing neurons, was revealed to be involved in feeding behavior.<!-- sending anorexigenic signals. // regulating -->
...
Conversely, in mice, reducing the activity of PKC`r knitr::asis_output("\U03B4")`-immunopositive cells in CeL was shown to reverse the effects of decreased feeding induced by sickness or unpalatable tastes [@cai_2014]. <!-- [@janak_2015] was found to block decreased feeding stimulated by sickness or unpalatable tastes-->
...
In contrast, the PKC-containing CeL neurons strongly project to and inhibit CeM neurons (@haubensak_2010; @li_2013a, Fig. \@ref(fig:amygdalaconnect), part c).
...
Moreover, both CeM and CeL neurons, especially those expressing CRF, send substantial projections to the BNST, affecting fear- and anxiety-related behaviors, such as freezing (@asok_2018, see Fig. \@ref(fig:amygdalaconnect), part b).
...
Furthermore, CeM neurons were reported to innervate PFC, which stimulation was shown to modulate reward-related behaviors (@seo_2016, see Fig. \@ref(fig:amygdalaconnect), part b). 
