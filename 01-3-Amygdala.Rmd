...
In addition, the BLA projects also to extended amygdala, that is to the BNST and the CeA, which are associated with anxiety and social interactions [@felixortiz_2013; @felixortiz_2014; @felixortiz_2016; @tye_2011].
...
Notably, the latter projection may be either direct or indirect *via* the intercalated cells (ITCs), GABAergic neurons surrounding the BLA. 
