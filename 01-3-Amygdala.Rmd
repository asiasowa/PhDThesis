...
Accumulating studies have illustrated that CeA projects to different brainstem sites. 
Briefly, both CeM and CeL neurons, especially those expressing CRF, send substantial projections to the BNST and locus coeruleus (LC), affecting fear- and anxiety-related behaviors, such as freezing (@asok_2018, @paretkar_2018, see Fig. \@ref(fig:amygdalaconnect), part b).
In addition, CeM cells projecting to the dorsal vagal complex (DVC) are implicated in autonomic regulation [@viviani_2011], whereas projection to PAG and PVT are thought to mediate defensive behaviour [@penzo_2014; @viviani_2011].
