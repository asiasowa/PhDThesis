...
The physiological and morphological properties of neurons in relation to specific nuclei are shown in Fig. \@ref(fig:amygdalastr), whereas their inputs, outputs and intra-connectivity are depicted in Fig. \@ref(fig: amygdalaconnectivity).
...
For instance, there is a subpopulation of SOM+ neurons, which expresses neuropeptide Y (NPY), whereas the PV group includes the basket and chandelier cells, also known as axo-axonic neurons (AAC), which will be discussed in the next section (for reviews: @hjos_2021, @prager_2016, @tremblay_2016). 
...
As mentioned above, this subpopulation constitutes around 40% of BLA interneurons, except in the lateral subdivision, where PV-expressing cells represent only 20% of BLA interneurons. -->
