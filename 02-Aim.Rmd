...
# options for printing figures outside this file:
# in pandoc option:
# output: 
#   slidy_presentation:
...
bad_Cells <- c(9, 8, 10, 12, 18) #poszarpana i brzydka - sEPSC; IV - RS - brzydkie 20d08045, 20813003, 20729032
...
df_basic$Condition <- factor(df_basic$Condition, levels = c("baseline",  "CX3CL1(2nM)", "AZD8797", "AZD8797 + \nCX3CL1(2nM)"))
...
bartek_pp2$Condition <- plyr::revalue(bartek_pp2$Condition, c("naive"="control","ADX 10 FRC 2"="AZD8797 + \nCX3CL1(2nM)", "adx 10uM" = "AZD8797 + \nCX3CL1(2nM)", "ADX 10um" = "AZD8797 + \nCX3CL1(2nM)" ,"fra con" = "control", "adx control" = "control",  "fra 2nM" = "CX3CL1(2nM)", "ADX FRC control" = "control"))
bartek_pp2$Condition <- factor(bartek_pp2$Condition, levels = c("control", "CX3CL1(2nM)", "AZD8797", "AZD8797 + \nCX3CL1(2nM)"))
