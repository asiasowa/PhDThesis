...
Briefly, receptors of CXCL12 and CX3CL1 chemokines are located in the amygdala (see Sections: \@ref(CX3CL1str) and \@ref(CXCL12str)); however, their specific distribution is not thoroughly examined. 
...
Functionally, previous studies have demonstrated complex electrophysiological effects of CXCL12 and CX3CL1, which differ between, among others, brain regions or neuronal populations (see Section: \@ref(chemointheCNS)).
...
bad_Cells <- c(4, 10, 14) # Rm - 478 -> 268 ; 10 - 20d14002 - only 1 spike after application; IV- 14
