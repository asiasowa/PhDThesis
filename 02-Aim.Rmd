...
Moreover, at least some of chemokine-triggered actions were mediated by glial cells.
...
To address these issues, whole-cell patch-clamp technique, supplemented with immunohistochemical methods, was employed. <!-- To further knowledge on these receptors in bone cells, patch clamp and cytosolic calcium measurements, supplemented with molecular biology and
...
To gain additional insights into chemokines' coordination of local communication between neurons, microglia, and astrocytes, the co-localization of chemokine (CXCL12/CX3CL1) or their receptors (CX3CR1/CXCR4) with markers of specific cell types (neurons, microglia, astrocytes) in the chosen amygdalar nuclei (BLA/CeA) was examined.
