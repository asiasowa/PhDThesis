...
# bartek_IV2aa<- bartek_IV2 %>% dplyr::filter(Condition == 'control') %>% dplyr::mutate(Experiment = 'control')
...
# bartek_IV2 <- bartek_IV2a %>% dplyr::bind_rows(bartek_IV2b) %>% dplyr::bind_rows(bartek_IV2c) %>% dplyr::bind_rows(bartek_IV2aa)
...
# bartek_pp2 <- bartek_pp2a %>% dplyr::bind_rows(bartek_pp2b) %>% dplyr::bind_rows(bartek_pp2c)
