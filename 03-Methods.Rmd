...
The determination of the doses for CX3CL1, CXCL12, AZD8797, AMD3100, minocycline, and fluorocitrate was based on previous studies [@sheridan_2014; @baxter_2021]<!--citations--><!--in which 100 $\upmu$M minocycline markedly reduced the frequency and amplitude of spontaneous EPSCs (sEPSCs) in hippocampal neurons (Gonzalez et al., 2007). - Peng2016 // CX3CL1 were purchased from .... and its final concentration were 2 and 5nM, according to studies -->
