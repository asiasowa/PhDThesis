...
```{r CX3CL1BLAexcitability, fig.cap='**CAPTION**', fig.align = 'center', echo = FALSE, message= FALSE, fig.height= 20, fig.width= 15, echo = FALSE, warning= FALSE, message = FALSE}
...
representative_frak2nM <- frak2nM_IV_subset %>% plot_IV_individual(mtitle = "") + theme(strip.text = element_text(size = 11, face="bold"), strip.background = element_blank()) # making a plot
## importing traces
...
representative_azdfrak2nM <- azdfrak2nM_IV_subset %>% plot_IV_individual(mtitle = "") + theme(strip.text = element_text(size = 11, face="bold"), strip.background = element_blank())
...
representative_minofrak2nM <- minofrak2nM_IV_subset %>% plot_IV_individual(mtitle = "") + theme(strip.text = element_text(size = 11, face="bold"), strip.background = element_blank())
...
representative_gabafrak2nM <- gabafrak2nM_IV_subset %>% plot_IV_individual(mtitle = "") + theme(strip.text = element_text(size = 11, face="bold"), strip.background = element_blank())
...
figure1 <- figure1 + plot_layout(heights = c(1, 4, 1))   
