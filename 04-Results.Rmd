...
Finally, considering that the activity of principal cells in the BLA is well-known to be tightly controlled by heterogeneous group of interneurons, I investigated whether blocking GABA~A~ and GABA~B~ receptors would eliminate the effect of CX3CL1, in the presence of picrotoxin (100 M) and CGP... (), respectively. <!-- dawki Treatment with both GABA~A~ and GABA~B~ antagonists (picrotoxin, 100 ... and ) ... fully abolished the neuronal response to CX3CL1.--> 
As expected, the CX3CL1 effect was abolished when the GABAergic receptors were blocked (Fig. `r CX3CL1_gabafrak2nM_BLA_stat_tres`, \@ref(fig:CX3CL1BLAexcitability)).
...
To address these issues and gain insights into how CX3CL1 modulate network activity, the extracellular recordings were employed. 
The observed in this study decrease in excitability, together with a decrease in GABAergic drive, was  As many reports indicated the effect of CX3CL1 on the LTP<!-- citations -->, together with accumulating evidence concerning the relevance of interneurons in this process in the BLA <!-- citations -->, ... <!-- dokończyć-->.
