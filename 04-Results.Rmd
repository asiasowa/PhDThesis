...
Hence, this observation was additionally confirmed using pharmacological inhibition of CX3CR1 receptor, a selective antagonist (AZD8797).<!-- by antagonist. -->
...
As presented in Fig. \@ref(fig:CX3CL1BLAexcitability), the inhibition of microglia also diminished the CX3CL1-induced effect on threshold current (`r CX3CL1_minofrak2nM_BLA_stat_tres`, \@ref(fig:CX3CL1BLAexcitability)).
