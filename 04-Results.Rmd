...
```{r CX3CL1BLAexcitability, fig.cap='**CAPTION**', fig.align = 'center', echo = FALSE, message= FALSE, fig.height= 18, fig.width= 15, echo = FALSE, warning= FALSE, message = FALSE}
...
We next explored the possible influence of CX3CL1 on the inhibitory transmission onto BLA PCs in *in vitro* slices. <!-- Next, We next explored the possible influence of harmine on the GABAergic transmission onto BA PNs. -->
...
To determine if the decrease in sIPSC frequency by CX3CL1 was due to a change in the spontaneous action potential firing in the slice, the TTX was used to block neuronal firing and the mIPSC amplitude and frequency was measured before and after CX3CL1 application (also clamped at 0 mV). <!-- Alternatively: To determine whether there was a direct effect of CX3CL1 on GABAergic terminals, miniature mIPSC (mIPSCs) were recorded from principal cells. In these experiments TTX was used to block the action potentials. --> 
