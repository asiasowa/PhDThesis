...
According to the literature,<!-- zmienić--> around 15% of Regular-Spiking neurons express PKC`r knitr::asis_output("\U03B4")`, whereas around 60% of all SOM-immunopositive neurons belong to the RS type [@haubensak_2010; @li_2013a].
Thus, it was hypothetized that having changed membrane properties in RS, CX3CR1 would be more present in SOM-positive neurons.
