...
Having found that mainly Regular-Spiking neurons are reactive to CX3CL1 application, as assessed by changes in input resistance, time membrane constant, and excitability, the next step was to examine whether these cell-specific effects are reflected in different CX3CR1 expression.
