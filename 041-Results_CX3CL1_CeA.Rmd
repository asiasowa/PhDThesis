...
This effect was accompanied by a reduced input resistance (`r CX3CL1_CeA_stat_RS_frak2nM_Rm`) and membrane time constant (`r CX3CL1_CeA_stat_frak2nM_RS_tau`; Fig. \@ref(fig:CX3CL1CeARmtau), middle panel).
...
To examine whether this effect was mediated by spontaneous firing of neurons in the slice, the experiment was performed in the presence of TTX (see Fig. \@ref(fig:CX3CL1CeAsIPSCfig)<!--part?-->.
...
Having found that mainly Regular-Spiking neurons are reactive to CX3CL1 application, as assessed by changes in input resistance, time membrane constant and excitability, the next step was to examine whether these effects are reflected by the specific CX3CR1 expression.
Unfortunately, those electrophysiological types are not clearly correlate with any molecular marker.
According to literature,<!-- zmienić--> around 15% of Regular-Spiking neurons express PKC`r knitr::asis_output("")`, whereas around 60% of all SOM-immunopositive neurons belong to the RS type [@haubensak_2010; @li_2013a].
According to the immunohistochemical data, CX3CR1 was co-expressed with <!-- --> % of SOM-positive and <!-- -->% of PKC`r knitr::asis_output("")`-expressing neurons in the CeL.
The neuronal expression of CX3CL1 was also assessed and it was .... in RS neurons and .... in LF neurons.

As the margin of error was relatively high<!-- jakoś inaczej to napisać?-->, the CX3CR1 expression was also directly verified by immunofluorescent staining of a set of slices with identified firing pattern of patched neurons.
<!-- we wanted  to know whether  neurons innately co-express TLR4 and MCP-1, thereby identifying the presence of a likely TLR4/MCP-1 signal that is the -->
