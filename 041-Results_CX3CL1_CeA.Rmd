...
bp_CeA_s_amp_sIPSC_LF  <- plot_boxplot(CeA_sIPSC_final_subset_LF, median_Amplitude, ylabel = "s/mIPSC Amplitude (pA)", vary1 = 0, vary2 = 40, dot_size = 2,  mtitle = "") + theme(plot.title = element_text(size= 16, face="bold"), axis.text.x = element_text(angle = 30, vjust = 0.7, hjust=0.5))
