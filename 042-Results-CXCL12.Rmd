...
When grouped together, CeL neurons displayed a reduced amplitude of sIPSCs in response to both 2nM and 5nM concentration of CXCL12 (baseline:`r round(CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(2nM)' & Condition == "baseline") %>% ungroup() %>% summarize(mean(median_Amplitude)), digits = 2)` `r knitr::asis_output("\U00B1")` `r round(CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(2nM)' & Condition == "baseline") %>% ungroup() %>% dplyr::summarize(x = sd(median_Amplitude), count = n()) %>% dplyr::summarize(x/sqrt(count)), digits = 3)`, CXCL12(2nM): `r round(CeA_sIPSC_all_subset  %>% filter(Experiment == 'CXCL12(2nM)' & Condition == "CXCL12") %>% ungroup() %>% summarize(mean(median_Amplitude)), digits = 2)` `r knitr::asis_output("\U00B1")` `r round(CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(2nM)' & Condition == "CXCL12") %>% ungroup() %>% dplyr::summarize(x = sd(median_Amplitude), count = n()) %>% dplyr::summarize(x/sqrt(count)), digits = 3)`, n = `r CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(2nM)') %>% ungroup() %>% dplyr::select(Cell) %>% n_distinct()`, N = `r CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(2nM)') %>% group_by(Filename) %>% mutate(animals = str_sub(Filename, start = 1, end = 5)) %>% ungroup() %>% dplyr::select(animals) %>% n_distinct()`, `r CeA_sIPSC_all_stats_amp_2nM` and baseline: `r round(CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(5nM)' & Condition == "baseline") %>% ungroup() %>% summarize(mean(median_Amplitude)), digits = 2)` `r knitr::asis_output("\U00B1")` `r round(CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(5nM)' & Condition == "baseline") %>% ungroup() %>% dplyr::summarize(x = sd(median_Amplitude), count = n()) %>% dplyr::summarize(x/sqrt(count)), digits = 3)` pA, CXCL12(5nM): `r round(CeA_sIPSC_all_subset  %>% filter(Experiment == 'CXCL12(5nM)' & Condition == "CXCL12") %>% ungroup() %>% summarize(mean(median_Amplitude)), digits = 2)` `r knitr::asis_output("\U00B1")` `r round(CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(5nM)' & Condition == "CXCL12") %>% ungroup() %>% dplyr::summarize(x = sd(median_Amplitude), count = n()) %>% dplyr::summarize(x/sqrt(count)), digits = 3)` pA, n = `r CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(5nM)') %>% ungroup() %>% dplyr::select(Cell) %>% n_distinct()`, N = `r CeA_sIPSC_all_subset %>% filter(Experiment == 'CXCL12(5nM)') %>% group_by(Filename) %>% mutate(animals = str_sub(Filename, start = 1, end = 5)) %>% ungroup() %>% dplyr::select(animals) %>% n_distinct()` `r CeA_sIPSC_all_stats_amp_5nM`, Fig.\@ref(fig:CX3CL1CeAsIPSCfig)b1).<!--lepiej?-->
