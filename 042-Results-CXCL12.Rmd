...
As shown in Fig.\@ref(fig:CXCL12BLAsIPSCfreq), at the concentration of 2nM, CXCL12 reduced the GABAergic transmission onto `r ((pie_BLA_c2_freq$data$count[1]/(pie_BLA_c2_freq$data$count[1] + pie_BLA_c2_freq$data$count[2] + pie_BLA_c2_freq$data$count[3]))* 100)` % of principal cells.
