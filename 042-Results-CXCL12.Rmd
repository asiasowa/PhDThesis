...
This was especially true for 5nM concentration; however, the high level of variation is observed (\@ref(fig:(CXCL12BLAintrinsic)b).
...
Moreover, other measured membrane intrinsic properties of principal cells were also seemed unaffected by CXCL12 treatment, as showed in Fig. \@ref() in Appendix \@ref()).
...
As shown in Fig.\@ref(fig:CXCL12BLAsEPSCfreq), it is tempting to speculate that while the concentration of 2nM does reduce the sEPSC... a partial reduction between NMDA and NMDA/CX3CL1 treated cells was observed, they were not statistical significant (`r CXCL12_2nM_BLA_sEPSC_stat_freq` and `r CXCL12_5nM_BLA_sEPSC_stat_freq`, respectively). 
...
The ability of exogenous CXCL12 to mediate inhibitory synaptic transmission was also assessed.
Indeed, similar to .... as reported in Figure 6 D , administration of CCL2 (100 nM, 30 min) to hippocampal cultures, during Glu insult, prevented neuronal cell death
