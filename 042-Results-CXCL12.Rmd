...
Data reported in Figure \@ref(fig:) demonstrates that CXCL12, especially at higher dose (5nM), enhanced CeL neurons' excitability, measured as input-output curve <!--statistics, albo gain albo coś...-->.
As described earlier, two main electrophysiological types of CeL neurons are Regular-Spiking and Late-Firing neurons.
Thus, further analysis revealed that although this CXCL12-induced increased firing can be observed in both types of cells (\@ref(fig:CXCL12CeAexc)), it is more prominent and statistically significant in Late-Firing neurons (<!-- baseline -->). 
...
A <- ((bp_CeA_cxcl12_gain | bp_CeA_cxcl12_gain_RS | bp_CeA_cxcl12_gain_LF) + plot_layout(tag_level = "new", widths = c(0.6, 0.6, 1)))
B <- ((bp_CeA_cxcl12_thres | bp_CeA_cxcl12_thres_RS | bp_CeA_cxcl12_thres_LF) + plot_layout(tag_level = "new", widths = c(0.6, 0.6, 1)))
