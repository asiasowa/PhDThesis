...
<!--summary and relevance of two chemokines-->
In this PhD dissertation, by using a combination of electrophysiological, immunohistochemical, and pharmacological approaches, the actions of two chemokines (CX3CL1 and CXCL12) was dissected in two nuclei of the amygdala - basolateral (BLA) and central (CeA). 
<!-- local regulation of glia important -->
<!--increasing evidence about chemokine role in psychiatric disorders-->
<!-- both chemokines crucial in the coordination of neuro-glial local communications-->
<!-- neurodevelopment?-->

## CX3CL1 in the basolateral amygdala
...
<!-- może coś o microglia? -->
Notably, this effect was not associated with any significant changes in passive membrane properties, such as input resistance.<!--Fig.--><!-- However, the input resistance and other passive membrane properties remained unchanged following CX3CL1 treatment, suggesting that this effect was rather presynaptic.-->
However, neuron's excitability is a result of neuron's intrinsic electrical properties as well as their excitatory and inhibitory synaptic inputs.<!--cytowanie jakiegos klasyka? // which may be a results of not only neuron’s intrinsic electrical properties, but also from excitatory and inhibitory synaptic inputs. -->

### reduced sIPSC frequency

As present data reported significant changes neither in passive membrane properties of pyramidal-like BLA neurons nor onto their excitatory synaptic transmission<!--poprawić-->, the main source of this effect may be underlying differences in inhibitory synaptic transmission.
Consistent with this idea, the CX3CL1-induced depression of principal cells firing was abolished by the GABA~A~ and GABA~B~ receptor blockers, picrotoxin and CGP52432 (Fig. \@ref(fig:)).<!--Consistent with the observed decrease in inhibitory synaptic transmission and lack of change in excitatory synaptic transmission (Figures \@ref(fig:)), the effects of CX3CL1 were abolished by the GABA~A~ and GABA~B~ receptor blockers, picrotoxin and CGP52432 (Fig. \@ref(fig:))-->
...
The reduction in average median frequency after CX3CL1 application may result from a<!--decreased inputs onto BLA principal cells, probably due to--> decreased number of GABAergic synapses onto principal cells, while the number of postsynaptic GABA~A~receptors remained the same.<!-- jakieś cytowanie?-->
...
<!--why when interneurons blocked there is no effect in threshold current, but sIPSC decreased? but it is consistent, as blocking TTX also abolished this effect :) nie wiem o co mi chodziło?-->
Rossi and GABA~A~ ? 
...
The reduced firing rate of neurons could be explained by their hyperpolarized resting membrane potential and a depolarized threshold potential, in accordance with Zonta et al (2011).<!-- zmienić i nie rozumiem jak to się ma do całości...-->
Indeed, GABAergic inputs were reported to be able to control spiking of pyramidal-like neurons in the BLA, especially when formed at the perisomatic region or AIS.<!--cytations--><!-- Indeed, it has been demonstrated  that  AACs  can  control  action  potential generation at the AIS of projection neurons via their GABAergic  inputs, either through changing the action potential  threshold,  or  by  shifting  the  site  of  origin (Douglas  and  Martin,  1990;  Somogyi et    al ,  1982; Wefelmeyer et  al , 2015; Veres et  al , 2014). Accordingly,-->
...
### microglia and independent CX3CL1 mechanisms of action in the BLA
...
Dendritic spines can take various shapes and have been classified on the basis of their structure as filopodial, thin, stubby,   fenestrated   or   mushroom-like [8] . 
