...
Given that intra-amygdala infusion of CXCL12 impaired the acquisition and extinction of conditioned fear response [@shi_2016], it is tempting to speculate that CXCL12 might be involved in this process.<!--Thus, it is tempting to speculate that CXCL12 at the 5nM might mimic changes associated with fear conditioning. -->
...
The mechanisms of astrocytic modulation of the CeL microcircuit have recently attracted much attention.<!--citations--><!--rozwinąć -->
