...
These interneurons target the AIS of principal cells, and the decrease in GABAergic synapses in this area was shown to change the threshold current needed for producing an action potential.
Moreover, this precise reduction of synapses in this critical area was shown to be mediated by microglia in the cortex.
Due to the well-documented abundance of the CX3CR1 receptor in the microglia and observed effects, it is possible a similar mechanism could be present in the amygdala.
...
Nevertheless, the reduced firing in the Regular-Firing cells is in good agreement with decreased frequency of sIPSCs onto Late-Firing cells, as the Regular-Spiking neurons were previously reported to send more dense and potent connections onto Late-Firing cells and *vice versa*. 

Interestingly, the pre-treatment with minocycline, probably by inhibition of microglia, increased in the firing of principal cells in the BLA and Late-Firing in the CeL. 
...
In the BLA, at the concentration of 5nM, the tendency toward the enhanced excitability of principal cells confirms the hypothesis from the previous study conducted by @yang_2016.
...
Nevertheless, most neurons responded with decreased frequency at the concentration of 2nM in the BLA, whereas at a higher dose, the median frequency of sIPSCs was increased.

On the other hand, in the CeL, the current results showed that the exogenous CXCL12 decreased threshold current, and thus increasing the excitability of both Regular-Spiking and Late-Firing neurons. 
...
Among the possible explanations of this effect, one might be the mechanism which is similar to what was observed by @li_2013a during fear-conditioning.
Specifically, the authors reported that BLA principal cells preferentially target Late-Firing neurons during the baseline condition, whereas after fear-conditioning, the pattern changed. 
Hence, one might speculate that the higher concentration of CXCL12 exerts anxiogenic effects. 

CXCL12 action on inhibitory synaptic transmission is not 


 
Altogether, data presented in this PhD dissertation lay the fundamental groundwork to investigate neuron-glia crosstalk and chemokine signaling in the amygdala.
...
Moreover, this study highlights the importance of using horizontal slices in electrophysiological approaches when investigating the excitatory synaptic transmission in the amygdala. 
Of note, observed opposing actions for CX3CL1/CX3CR1 and CXCL12/CXCR4 make chemokine signaling in the amygdala highly dynamic, which is further amplified by their ability to interfere with synaptic plasticity and morphology of dendritic spines, at least for the CX3CL1. 
In addition, the work presented here builds on the previously presented modulation of GABA synaptic activity at 5-HT neurons by CX3CL1 and CXCL12 by adding their regulation of amygdala microcircuits. 
