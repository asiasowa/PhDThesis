...
In the present work, the effects of two structurally different chemokines, CX3CL1 and CXCL12, on electrophysiological properties as well as synaptic transmission in the amygdala were investigated, mainly by employing a whole-cell patch-clamp technique. 
...
The findings presented in this PhD dissertation illustrate that both CX3CL1 and CXCL12 modulate the activity of the amygdala network; however, in an opposite manner.
The main findings of the study regarding CX3CL1 in the BLA are as follows:
the CX3CL1 application decreased excitability and impaired LTP at the concentration of 5nM.
In addition, GABAergic synaptic transmission was downregulated following CX3CL1 application.
Based on these observations and previous literature regarding similar mechanisms in the BLA [@saha_2016; @veres_2014; @wefelmeyer_2015; @zonta_2011], we speculate that CX3CL1 acts on PV-expressing subpopulation of BLA interneurons. 
These interneurons target the AIS of principal cells, and decreased GABAergic activity in this area was shown to change the threshold current needed for eliciting an action potential.
...
The deletion of CX3CR1 in microglia led to neuronal death in such models as systemic inflammation, amyotrophic lateral sclerosis (ALS), and Parkinson’s disease (PD) [@cardona_2006], implicating CX3CL1/CX3CR1 signaling in pathophysiological augmentation of glutamatergic transmission.
Moreover, the upregulation of CX3CL1 was shown to reduce neurodegeneration in an animal model of PD [@morganti_2012] or AD [@finneran_2019].
...
Nevertheless, most neurons responded with decreased frequency of sIPSCs at the concentration of 2nM in the BLA, whereas at a higher concentration (5nM), the median frequency of sIPSCs was increased.
...
This is consistent with our data showing elevated excitability of principal neurons at the higher concentration.
...
This may be linked with observations that the intra-amygdala infusion of CXCL12 impaired the acquisition and extinction of conditioned fear response [@shi_2016].
...
Findings obtained in this study illustrated that CXCL12 also affected the GABAergic system.
Specifically, CXCL12 was shown to increase the frequency of sIPSCs in Regular-Firing neurons and decrease the amplitude of those currents in the Late-Firing neurons.
Moreover, both action potential-dependent and astrocytic mechanisms were illustrated to be involved in those effects.  
This is in line with another study, where the intra-amygdala infusion of CXCL12 led to impairment of fear acquisition and extinction in a GABA~A~ and GABA~B~ receptors-dependent manner [@shi_2016].
Hence, further investigations into how CXCL12 modulates fear-conditioning and anxiety are of high importance.
