...
Finding presented in this PhD dissertation illustrate that both CX3CL1 and CXCL12 modulate the activity of the amygdala network; however, in an opposite manner.
...
CX3CL1/CX3CR1 signaling is implicated with pathophysiological augmentation of glutamatergic transmission, as deletion of CX3CR1 in microglia led to neuronal death in such models as systemic inflammation, amyotrophic lateral sclerosis (ALS), and Parkinson’s disease (PD) [@cardona_2006], whereas upregulation of CX3CL1 was shown to reduce neurodegeneration in model of PD [@morganti_2012] or AD [@finneran_2019].
...
The results concerning CXCL12 are less straightforward.<!--jakoś inaczej napisać..-->
...
Moreover, as suggested by @halbach_2002, the obtained data highlights the importance of using horizontal slices in electrophysiological approaches when investigating the excitatory synaptic transmission in the amygdala. 
