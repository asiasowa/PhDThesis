...
```{r CX3CL1_BLA_excitability_fig_all, fig.cap= '', fig.align = 'center', echo= FALSE, message= FALSE, warning = FALSE, error = FALSE, results='asis', fig.height= 12, fig.width= 12}
...
figure1 <- (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_gain + theme(legend.position = "none")) /  ((pie_BLA_frak_gain | pie_BLA_frak5nM_gain |  pie_BLA_antifrak_gain | pie_BLA_azdfrak_gain | pie_BLA_azd_gain | pie_BLA_minofrak_gain | pie_BLA_mino_gain | pie_BLA_picro_gain) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))   # gain

#figure1 <- figure1 + plot_layout(heights = c(1, 2, 1)) + wrap_plots(A= inset_frak2nM, B= inset_frak5nM, C= inset_ab, D = inset_azdfrak2nM, E= inset_azda, Z= inset_minofrak2nM, G= inset_minoa, H = inset_gaba, I = bp_BLA_gain, J= pie_BLA_frak_gain, K=pie_BLA_frak5nM_gain,  L=pie_BLA_antifrak_gain,  M= pie_BLA_azdfrak_gain, N = pie_BLA_azd_gain, O= pie_BLA_minofrak_gain, P= pie_BLA_mino_gain, R= pie_BLA_picro_gain, design = layout)

figure1 <- figure1 + plot_layout(heights = c(1, 2, 1))

figure1


figure2 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_adap + theme(legend.position = "none")) /  ((pie_BLA_frak_adap | pie_BLA_frak5nM_adap |  pie_BLA_antifrak_adap | pie_BLA_azdfrak_adap | pie_BLA_azd_adap | pie_BLA_minofrak_adap | pie_BLA_mino_adap | pie_BLA_picro_adap) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure2 <- figure2 + plot_layout(heights = c(1, 2, 1))   

figure2

figure3 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_rm + theme(legend.position = "none")) /  ((pie_BLA_frak_rm | pie_BLA_frak5nM_rm |  pie_BLA_antifrak_rm | pie_BLA_azdfrak_rm | pie_BLA_azd_rm | pie_BLA_minofrak_rm | pie_BLA_mino_rm | pie_BLA_picro_rm) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure3 <- figure3 + plot_layout(heights = c(1, 2, 1))   

figure3

figure4 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_tau + theme(legend.position = "none")) /  ((pie_BLA_frak_tau | pie_BLA_frak5nM_tau |  pie_BLA_antifrak_tau | pie_BLA_azdfrak_tau | pie_BLA_azd_tau | pie_BLA_minofrak_tau | pie_BLA_mino_tau | pie_BLA_picro_tau) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure4 <- figure4 + plot_layout(heights = c(1, 2, 1))   

figure4

#cap

figure5 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_cap + theme(legend.position = "none")) /  ((pie_BLA_frak_cap | pie_BLA_frak5nM_cap |  pie_BLA_antifrak_cap | pie_BLA_azdfrak_cap | pie_BLA_azd_cap | pie_BLA_minofrak_cap | pie_BLA_mino_cap | pie_BLA_picro_cap) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure5 <- figure5 + plot_layout(heights = c(1, 2, 1))   

figure5

#vm

figure6 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_vm + theme(legend.position = "none")) /  ((pie_BLA_frak_vm | pie_BLA_frak5nM_vm |  pie_BLA_antifrak_vm | pie_BLA_azdfrak_vm | pie_BLA_azd_vm | pie_BLA_minofrak_vm | pie_BLA_mino_vm | pie_BLA_picro_vm) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure6 <- figure6 + plot_layout(heights = c(1, 2, 1))   

figure6

# apw

figure7 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_apw + theme(legend.position = "none")) /  ((pie_BLA_frak_apw | pie_BLA_frak5nM_apw |  pie_BLA_antifrak_apw | pie_BLA_azdfrak_apw | pie_BLA_azd_apw | pie_BLA_minofrak_apw | pie_BLA_mino_apw | pie_BLA_picro_apw) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure7 <- figure7 + plot_layout(heights = c(1, 2, 1))   

figure7

# apa

figure8 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_apa + theme(legend.position = "none")) /  ((pie_BLA_frak_apa | pie_BLA_frak5nM_apa |  pie_BLA_antifrak_apa | pie_BLA_azdfrak_apa | pie_BLA_azd_apa | pie_BLA_minofrak_apa | pie_BLA_mino_apa | pie_BLA_picro_apa) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure8 <- figure8 + plot_layout(heights = c(1, 2, 1))   

figure8

# fast

figure9 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_fast + theme(legend.position = "none")) /  ((pie_BLA_frak_fast | pie_BLA_frak5nM_fast |  pie_BLA_antifrak_fast | pie_BLA_azdfrak_fast | pie_BLA_azd_fast | pie_BLA_minofrak_fast | pie_BLA_mino_fast | pie_BLA_picro_fast) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure9 <- figure9 + plot_layout(heights = c(1, 2, 1))   

figure9

# sag

figure10 <-   (inset_frak2nM  | inset_frak5nM | inset_ab | inset_azdfrak2nM | inset_azda | inset_minofrak2nM | inset_minoa | inset_gaba) /
  (bp_BLA_sag + theme(legend.position = "none")) /  ((pie_BLA_frak_sag | pie_BLA_frak5nM_sag |  pie_BLA_antifrak_sag | pie_BLA_azdfrak_sag | pie_BLA_azd_sag | pie_BLA_minofrak_sag | pie_BLA_mino_sag | pie_BLA_picro_sag) +  plot_layout(guides = "collect") & theme(legend.position = "bottom"))

figure10 <- figure10 + plot_layout(heights = c(1, 2, 1))   
