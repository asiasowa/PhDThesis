...
# RESTING MEMBRANE POTENTIAL
bp_CeA_vm <- plot_boxplot(CeA_df_final_12, RMS, mtitle = "", ylabel = "Resting membrane potential (mV)", vary1 = -95, vary2 = -30, dot_size = 2)
...
bp_CeA_vm_LF <- plot_boxplot(CeA_df_final_12_LF, RMS, mtitle = "", ylabel = "Resting membrane potential (mV)", vary1 = -95, vary2 = -30, dot_size = 2)
...
bp_CeA_vm_RS <- plot_boxplot(CeA_df_final_12_RS, RMS, mtitle = "", ylabel = "Resting membrane potential (mV)", vary1 = -95, vary2 = -30, dot_size = 2)
...
E <- (bp_CeA_apw | bp_CeA_apw_LF | bp_CeA_apw_RS) + plot_layout(tag_level = "new", widths = c(1, 1, 0.5))
...
H <- (bp_CeA_vm | bp_CeA_vm_LF | bp_CeA_vm_RS) + plot_layout(tag_level = "new", widths = c(1, 1, 0.5))
