...
# GAIN
bp_CeA_RS_thres <- plot_boxplot(CeA_df_frak2nM_sub_RS, Treshold1_all, mtitle= "Regular-Spiking", ylabel = "Treshold_all1", dot_size = 2)
...
bp_CeA_LF_thres <- plot_boxplot(CeA_df_frak2nM_sub_LF, Treshold1_all, mtitle= "Late-Firing", ylabel = "Treshold_all1",  dot_size = 2)
