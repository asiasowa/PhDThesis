...
# GAIN
bp_CeA_RS_thres <- plot_boxplot(CeA_df_azd_sub_RS, Treshold1_all, mtitle= "Threshold", ylabel = "Treshold_all1", dot_size = 2)
...
bp_CeA_LF_thres <- plot_boxplot(CeA_df_azd_sub_LF, Treshold1_all, mtitle= "Threshold", ylabel = "Treshold_all1",  dot_size = 2)
...
# ADAPTATION
bp_CeA_RS_adap <- plot_boxplot(CeA_df_azd_sub_RS, Adaptation_ratio, ylabel = "Adaptation ratio", mtitle = "Adaptation Ratio", vary1 = 0, vary2 = 1.5, dot_size = 2)
...
bp_CeA_LF_adap <- plot_boxplot(CeA_df_azd_sub_LF, Adaptation_ratio, ylabel = "Adaptation ratio", mtitle = "Adaptation Ratio", vary1 = 0, vary2 = 1.5, dot_size = 2)
...
# CAPACITANCE
bp_CeA_RS_cap <- plot_boxplot(CeA_df_azd_sub_RS, C_20, ylabel = "Capacitance (pF)", mtitle = "Capacitance", dot_size = 2)
...
bp_CeA_LF_cap <- plot_boxplot(CeA_df_azd_sub_LF, C_20, ylabel = "Capacitance (pF)", mtitle = "Capacitance", dot_size = 2)
...
# ACTION POTENTIAL WIDTH
bp_CeA_RS_apw <- plot_boxplot(CeA_df_azd_sub_RS, AP_width1_all, ylabel = "Action potential width (ms)", mtitle = "Action potential width", dot_size = 2)
...
#   strip.text = element_text(size = 11, face="bold"), strip.background = element_blank()) #+ stat_compare_means(method = 't.test', hide.ns = TRUE, label = 'p.signif', paired = TRUE, label.x.npc = 'center', var.equal = TRUE)
bp_CeA_LF_apw <- plot_boxplot(CeA_df_azd_sub_LF, AP_width1_all, ylabel = "Action potential width (ms)", mtitle = "Action potential width", dot_size = 2)
...
# ACTION POTENTIAL AMPLITUDE
bp_CeA_RS_apa <- plot_boxplot(CeA_df_azd_sub_RS, AP_amp1_all, ylabel = "Action potential amplitude (pA)", mtitle = "Action potential amplitude", dot_size = 2)
...
#   strip.text = element_text(size = 11, face="bold"), strip.background = element_blank()) #+ stat_compare_means(method = 't.test', hide.ns = TRUE, label = 'p.signif', paired = TRUE, label.x.npc = 'center', var.equal = TRUE)
bp_CeA_LF_apa <- plot_boxplot(CeA_df_azd_sub_LF, AP_amp1_all, ylabel = "Action potential amplitude (pA)", mtitle = "Action potential amplitude", dot_size = 2)
...
# FAST AHP
bp_CeA_RS_fast <- plot_boxplot(CeA_df_azd_sub_RS, AHPf1_all, ylabel = "fast AHP (pA)", mtitle = "fast AHP", dot_size = 2)
...
#   strip.text = element_text(size = 11, face="bold"), strip.background = element_blank()) #+ stat_compare_means(method = 't.test', hide.ns = TRUE, label = 'p.signif', paired = TRUE, label.x.npc = 'center', var.equal = TRUE)
bp_CeA_LF_fast <- plot_boxplot(CeA_df_azd_sub_LF, AHPf1_all, ylabel = "fast AHP (pA)", mtitle = "fast AHP",  dot_size = 2)
...
figure1 <- (((bp_CeA_RS_thres | bp_CeA_LF_thres) + plot_layout(tag_level = 'new')) | ((bp_CeA_RS_adap | bp_CeA_LF_adap) + plot_layout(tag_level = 'new'))) / 
            (((bp_CeA_RS_cap | bp_CeA_LF_cap) + plot_layout(tag_level = 'new')) | ((bp_CeA_RS_apw | bp_CeA_LF_apw) + plot_layout(tag_level = 'new'))) /
            (((bp_CeA_RS_apa | bp_CeA_LF_apa) + plot_layout(tag_level = 'new')) |  ((bp_CeA_RS_fast | bp_CeA_LF_fast) + plot_layout(tag_level = 'new'))) 
