...
All membrane effects of CX3CL1, AZD8797 or minocycline application are summarized in Table <!-- -->.
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
   tab_source_note(source_note = md("")) %>%
   gtsave("CX3CL1_CeA_membr_table.html")

knitr::include_graphics("CX3CL1_CeA_membr_table.html")
...
The data are shown in Table <!-- --> and are illustrated on Fig. <!-- -->
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
    tab_source_note(source_note = md("")) %>%
    gtsave("CeA_CX3CL1_sEPSC_table.html")

knitr::include_graphics("CeA_CX3CL1_sEPSC_table.html")
...
Table <!----> summarizes the statistics regarding sIPSC characteristics after CX3CL1, AZD8797, and minocycline application. 
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
    tab_source_note(source_note = md("")) %>%
    gtsave("CeA_CX3CL1_sIPSC_table.html")

knitr::include_graphics("CeA_CX3CL1_sIPSC_table.html")
...
As presented in Table ...<!-- --> and Fig. \@ref(fig:), treatment with CXCL12 had negligable effect on measured membrane parameters.
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
   tab_source_note(source_note = md(""))  %>%
             gtsave("CXCL12_BLA_membrane_table.html")

knitr::include_graphics("CXCL12_BLA_membrane_table.html")
```
...
Data illustrated in Table <!-- --> and Figure \@ref(fig:CXCL12BLAsEPSCfigall) indicate that exogenous CXCL12 did not affect excitatory synaptic transmission. 
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
      tab_header(
    title = ("Table 7.x. Statistics of all measured parameters regarding CXCL12 effects on excitatory synaptic transmission onto BLA principal cells"),
     subtitle = md("")) %>%
    opt_row_striping() %>%
   tab_source_note(source_note = md("")) %>%
   gtsave("CXCL12_BLA_sEPSC_table.html")

knitr::include_graphics("CXCL12_BLA_sEPSC_table.html")
...
CXCL12 does not induce any marked change in GABAergic transmission in the BLA (see Table <!-- --> and Fig. \@ref(fig:CXCL12BLAsIPSCall)).
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
   tab_source_note(source_note = md("")) %>%
   gtsave("CXCL12_BLA_sIPSC_table.html")

knitr::include_graphics("CXCL12_BLA_sIPSC_table.html")
...
Table <!-- --> and Figures \@ref(fig:CXCl12CeAmembrfigall1) and \@ref(fig:CXCl12CeAmembrfigall2) report no prominent difference in membrane properties of CeL neurons.
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
      tab_header(
    title = ("Table 7.4. Summary of all measured membrane parameters in CeL neurons following CXCL12 treatment, focusing on their two electrophysiological types"),
     subtitle = md("")) %>%
    opt_row_striping() %>%
   tab_source_note(source_note = md("")) %>%
   gtsave("CXCL12_CeA_membr_table.html")

knitr::include_graphics("CXCL12_CeA_membr_table.html")
...
The detailed summary regarding CXCL12 actions on excitatory synaptic transmission in the CeL is presented in Table <!-- --> and Fig. \@ref(fig:CXCL12CeAsEPSCappen).
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
      tab_header(
    title = ("Table 7.5. sEPSC characteristics before and after CXCL12 application in CeL neurons"),
     subtitle = md("")) %>%
    opt_row_striping() %>%
    tab_source_note(source_note = md("")) %>%
    gtsave("CeA_CXCL12_sEPSC_table.html")

knitr::include_graphics("CeA_CXCL12_sEPSC_table.html")
...
CXCL12 does not modulate kinetics of spontaneous and miniature inhibitory postsynaptic currents in the CeL, as shown in Table <!-- --> and Fig. \@ref(fig:).
...
#  tab_options(
 #   table.width = pct(100)) %>%
    ...
    opt_row_striping() %>%
      tab_header(
    title = ("Table 7.X. sIPSCs characteristics before and after CXCL12 application in CeL neurons"),
     subtitle = md("")) %>%
    opt_row_striping() %>%
    tab_source_note(source_note = md("")) %>%
    gtsave("CeA_CXCL12_sIPSC_table.html")

knitr::include_graphics("CeA_CXCL12_sIPSC_table.html")
...
bp_CeA_rt_sIPSC_all <- plot_boxplot(CeA_sIPSC_all_subset1, median_RiseTime, ylabel = "s/mIPSC Rise Time (ms)", vary1 = 0, vary2 = 5, dot_size = 2,  mtitle = "") + theme(plot.title = element_text(size= 16, face="bold"), axis.text.x = element_text(angle = 30, vjust = 0.7, hjust=0.5)) 
...
bp_CeA_rt_sIPSC_LF <- plot_boxplot(CeA_sIPSC_LF_subset1, median_RiseTime, ylabel = "s/mIPSC Rise Time (ms)", vary1 = 0, vary2 = 5, dot_size = 2,  mtitle = "") + theme(plot.title = element_text(size= 16, face="bold"), axis.text.x = element_text(angle = 30, vjust = 0.7, hjust=0.5)) 
...
bp_CeA_rt_sIPSC_RS <- plot_boxplot(CeA_sIPSC_RS_subset1, median_RiseTime, ylabel = "s/mIPSC Rise Time (ms)", vary1 = 0, vary2 = 5, dot_size = 2,  mtitle = "") + theme(plot.title = element_text(size= 16, face="bold"), axis.text.x = element_text(angle = 30, vjust = 0.7, hjust=0.5)) 
...
# making boxplots for amplitude
bp_CeA_dt_sIPSC_all  <- plot_boxplot(CeA_sIPSC_all_subset1, median_DecayTau, ylabel = "s/mIPSC Decay Time (ms)", vary1 = 0, vary2 = 40, dot_size = 2,  mtitle = "") + theme(plot.title = element_text(size= 16, face="bold"), axis.text.x = element_text(angle = 30, vjust = 0.7, hjust=0.5))
...
bp_CeA_dt_sIPSC_LF  <- plot_boxplot(CeA_sIPSC_LF_subset1, median_DecayTau, ylabel = "s/mIPSC Decay Time (ms)", vary1 = 0, vary2 = 40, dot_size = 2,  mtitle = "") + theme(plot.title = element_text(size= 16, face="bold"), axis.text.x = element_text(angle = 30, vjust = 0.7, hjust=0.5))
...
bp_CeA_dt_sIPSC_RS  <- plot_boxplot(CeA_sIPSC_RS_subset1, median_DecayTau, ylabel = "s/mIPSC Decay Time (ms)", vary1 = 0, vary2 = 40, dot_size = 2,  mtitle = "") + theme(plot.title = element_text(size= 16, face="bold"), axis.text.x = element_text(angle = 30, vjust = 0.7, hjust=0.5))
